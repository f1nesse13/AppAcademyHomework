...
var GiphysIndex = function GiphysIndex(_ref) {
  ...
  console.log(giphys);
  var giphyLi = giphys.map(function (giphy, i) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("ul", null, giphyLi);
};
...
function (_Component) {
  ...
  function GiphysSearch(props) {
    ...
    _this.fetchSearchGiphys = _this.props.fetchSearchGiphys.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    return _this;
  }
  ...
  _createClass(GiphysSearch, [{
    ...
    value: function handleSubmit(e) {
      ...
      e.preventDefault();
      this.fetchSearchGiphys(this.state.search_term).then(function (res) {
        _this2.setState({
          search_term: '',
          giphysData: res.giphys.data
        });
      });
    }
  }, {
